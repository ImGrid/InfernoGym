...
def load_tfrecord_data(tfrecord_path, label_filter=4):
            ...
            if results.pose_landmarks:
                ...
                if len(keypoints) == 9:
                    ...
                    if label in ['Arriba', 'Abajo']:
                        if estado_actual == 'Arriba' and label == 'Abajo':
                            estado_actual = 'Abajo'
                        elif estado_actual == 'Abajo' and label == 'Arriba':
                            estado_actual = 'Arriba'
                            repetitions += 1
