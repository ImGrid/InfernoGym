...
def validate_file_content(file_path):
    """
    Utiliza la biblioteca `filetype` para validar que el contenido del archivo corresponda a un tipo permitido.
    """
    ...
    # Asegúrate de que el tipo MIME del archivo corresponda a los tipos de video permitidos
    valid_mime_types = {'video/mp4', 'video/x-msvideo', 'video/quicktime', 'video/x-flv', 'video/x-ms-wmv'}
    return kind.mime in valid_mime_types
